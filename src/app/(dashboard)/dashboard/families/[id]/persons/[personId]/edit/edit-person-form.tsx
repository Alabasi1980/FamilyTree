...
export default function EditPersonForm({ person, familyId }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      {/* ── Mode toggle ── */}
      <div className="flex items-center gap-2 rounded-xl border border-border/40 bg-card/30 p-1">
        <button
          type="button"
      ...
      <section className="grid grid-cols-1 gap-4 rounded-xl border border-border/50 bg-card/35 p-4 sm:grid-cols-2">
        <p className="sm:col-span-2 text-[10px] font-semibold text-muted-foreground uppercase tracking-widest pb-1 border-b border-border/30">
          {mode === "quick" ? "البيانات الأساسية" : "البيانات الشخصية"}
        </p>
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 rounded-lg border py-2 text-sm transition-colors ${
                isLiving
                  ? "border-green-700 bg-green-900/20 font-medium text-foreground"
                  : "border-border text-muted-foreground hover:border-border/80"
              }`}
            >
              حي
            ...
            <button
              ...
              className={`flex-1 rounded-lg border py-2 text-sm transition-colors ${
                !isLiving
                  ? "border-muted-foreground/50 bg-muted/20 font-medium text-foreground"
                  : "border-border text-muted-foreground hover:border-border/80"
              }`}
            >
              متوفى
      ...
      {/* ── Full mode extra sections ── */}
      {mode === "full" && (
        <>
          <section className="grid grid-cols-1 gap-4 rounded-xl border border-border/50 bg-card/35 p-4 sm:grid-cols-2">
            <p className="sm:col-span-2 text-[10px] font-semibold text-muted-foreground uppercase tracking-widest pb-1 border-b border-border/30">تفاصيل إضافية</p>
          ...
          <section className="grid grid-cols-1 gap-4 rounded-xl border border-border/50 bg-card/35 p-4 sm:grid-cols-2">
            <p className="sm:col-span-2 text-[10px] font-semibold text-muted-foreground uppercase tracking-widest pb-1 border-b border-border/30">التواريخ والولادة</p>
          ...
          <section className="grid grid-cols-1 gap-4 rounded-xl border border-border/50 bg-card/35 p-4 sm:grid-cols-2">
            <p className="sm:col-span-2 text-[10px] font-semibold text-muted-foreground uppercase tracking-widest pb-1 border-b border-border/30">الإقامة والصورة</p>
          ...
          <section className="space-y-4 rounded-xl border border-border/50 bg-card/35 p-4">
            <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-widest pb-1 border-b border-border/30">الخصوصية والملاحظات</p>
            <div className="space-y-1.5">
